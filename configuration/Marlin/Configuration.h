...
#define STRING_CONFIG_H_AUTHOR "(M. Kanawati)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 133.65
  #define DEFAULT_bedKi 26.31
  #define DEFAULT_bedKd 452.63
 ...
 *                                      X,   Y,    Z,  E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 200, 160, 410 } // 592 Steps for M4 Extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 24, -4 } // Suppose to be { 0, -24, -3.7 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 30, 40, 30, 40 } // (mm) Left, Front, Right, Back insets
...
#define HOMING_FEEDRATE_MM_M { (70*60), (65*60), (4*60) }
